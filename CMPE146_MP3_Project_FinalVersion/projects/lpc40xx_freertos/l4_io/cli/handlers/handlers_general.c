...
//   if (sl_string__get_length(user_input_minus_command_name) <= 32) {
//     strncpy(track, user_input_minus_command_name, 32);
//     printf("before send to Q\n");
//     xQueueSend(Q_songname, track, portMAX_DELAY);
//     printf("Sent %s over to the Q_songname\n", user_input_minus_command_name);
//   } else {
//     printf("Error: please enter in a song again \n");
//   }
//   return APP_CLI_STATUS__SUCCESS;
// }